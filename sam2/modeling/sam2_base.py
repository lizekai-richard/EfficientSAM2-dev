...
class SAM2Base(torch.nn.Module):
    ...
    def forward_image(self, img_batch: torch.Tensor, cached_high_res_feats=None):
        """Get the image feature on the input batch."""
        backbone_out = self.image_encoder(img_batch, cached_high_res_feats)
    ...
    def _prepare_memory_conditioned_features(
        ...
        pix_feat_with_mem, mem_cas = self.memory_attention(
        ...
        pix_feat_with_mem = pix_feat_with_mem.permute(1, 2, 0).view(B, C, H, W)
        return pix_feat_with_mem, mem_cas
    ...
    def track_step(
        ...
        if mask_inputs is not None and self.use_mask_input_as_output_without_sam:
            ...
            pix_feat_with_mem, mem_cas = self._prepare_memory_conditioned_features(
                frame_idx=frame_idx,
